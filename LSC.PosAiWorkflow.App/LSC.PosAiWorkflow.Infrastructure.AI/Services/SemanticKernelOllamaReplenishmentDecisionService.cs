...
public sealed class SemanticKernelOllamaReplenishmentDecisionService : IReplenishmentDecisionService
{
    private readonly IChatCompletionService _chatCompletionService;
    private readonly OllamaOptions _ollamaOptions;

    public SemanticKernelOllamaReplenishmentDecisionService(
    ...
    private static ReplenishmentDecisionResponseModel ParseResponse(string rawText)
    {
        ...
        if (parsed is null)
        {
            throw new InvalidOperationException("Failed to deserialize Ollama replenishment response.");
        }
