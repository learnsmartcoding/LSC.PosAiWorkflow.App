...
dotnet ef dbcontext scaffold "Server=localhost\SQLEXPRESS;Initial Catalog=PosAiWorkflowSimDb;Integrated Security=SSPI; MultipleActiveResultSets=true;TrustServerCertificate=True;" Microsoft.EntityFrameworkCore.SqlServer -o Entities -d
